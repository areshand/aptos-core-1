module nft_dao::nft_dao_events {
    ...
    struct CreateDAOEvent has drop, store {
        dao_name: String,
        dao_resolve_denominator: u64,
        dao_resolve_numerator: u64,
        controlled_account: address,
        voting_duration: u64,
    ...
    public fun emit_create_dao_event(
        ...
        let event = CreateDAOEvent {
            dao_name,
            dao_resolve_denominator,
            dao_resolve_numerator,
            controlled_account,
            voting_duration,
            min_proposal_weight,
